    ...
    <div className="min-h-screen bg-bg flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <div className="text-txt-2 text-xs tracking-widest uppercase">análise inteligente de apostas</div>
        </div>
        ...
        <div className="bg-bg-2 border border-border rounded p-6">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div>
              <label className="block text-txt-3 text-xs uppercase tracking-wider mb-1.5">Email</label>
              <input
            ...
            <div>
              <label className="block text-txt-3 text-xs uppercase tracking-wider mb-1.5">Senha</label>
              <input
            ...
            {success && <div className="text-success text-xs bg-success/5 border border-success/20 rounded px-3 py-2">{success}</div>}
