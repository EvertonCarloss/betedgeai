...
export default function DashboardPage() {
  ...
  sorted.forEach((b) => {
    if (b.outcome === 'won')
      bal = bal - b.stake + (b.real_return ?? b.potential_return);
        ...
        <div className="col-span-2 space-y-4">
          <Card>
            ...
            {chartData.length > 1 ? (
              ...
              <div className="h-40 flex items-center justify-center text-txt-3 text-xs">
                Registre apostas para ver a evolução do saldo.
              </div>
            )}
          </Card>
          ...
          <Card>
            ...
            {recent.length ? (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-txt-3">
                          {formatDate(b.created_at)} · odd{' '}
                          {b.total_odd.toFixed(2)} · {formatCurrency(b.stake)}
                        </div>
                      </div>
              ...
              <div className="py-8 text-center text-txt-3 text-xs">
          ...
          <Card>
            ...
            {(() => {
              ...
              return entries.length ? (
                <div className="space-y-2">
                  {entries.map(([icon, d]) => {
                    ...
                    return (
                      ...
                      >
                        <span className="w-20 text-txt-2 truncate">
                          {icon} {names[icon] || icon}
                        </span>
                        ...
                        <span className="text-txt-3 w-8 text-right">
                          {pct}%
                        </span>
                      </div>
                    );
                ...
                <div className="text-txt-3 text-xs py-2">
